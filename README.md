...
El problema se va abordar con la implementación de una arquitectura convolucional 3D que integra descriptores SPD, usando una función de perdida contrastiva, de este proyecto se espera poder contribuir a el problema médico, lo cual es realmente importante y se espera que el modelo sea sobresaliente no generando altos falsos positivos y no tenga baja especificidad.
